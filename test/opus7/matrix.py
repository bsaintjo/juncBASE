...
class Matrix(object):
    ...
    transpose = property(fget=lambda self: self.getTranspose())
    ...
    def test(mat):
        ...
        k = 0
        for i in range(mat.numberOfRows):
    ...
    def testTimes(mat1, mat2):
        ...
        mat2[1, 0] = 2
        mat2[2, 0] = 3
        for i in range(mat1.numberOfRows):
            for j in range(mat1.numberOfColumns):
                print(mat1[i, j], end=' ')
            print()
        for i in range(mat2.numberOfRows):
            for j in range(mat2.numberOfColumns):
                print(mat2[i, j], end=' ')
            print()
        mat1 = mat2 * mat1
        for i in range(mat1.numberOfRows):
