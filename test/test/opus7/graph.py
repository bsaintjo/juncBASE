...
#[
        ...
        def __str__(self):
            ...
            if self._weight is None:
                ...
                return "Vertex {%d, weight = %s}" % (self._number,
                                                     str(self._weight))
        ...
        class PredecessorIterator(Iterator):
            ...
            def __init__(self, vertex):
                ...
                """
                super(Graph.Vertex.PredecessorIterator,
                      self).__init__(self._vertex._graph)
                self._vertex = vertex
        ...
        class SuccessorIterator(Iterator):
            ...
            def __init__(self, vertex):
                ...
                """
                super(Graph.Vertex.SuccessorIterator,
                      self).__init__(vertex._graph)
                self._vertex = vertex
...
#{
    ...
    numberOfEdges = property(fget=lambda self: self.getNumberOfEdges())

    @abstractmethod
    def getNumberOfVertices(self):
        pass

    numberOfVertices = property(fget=lambda self: self.getNumberOfVertices())
    ...
    isConnected = property(fget=lambda self: self.getIsConnected())

    @abstractmethod
    def getIsCyclic(self):
        pass

    isCyclic = property(fget=lambda self: self.getIsCyclic())
    ...
    edges = property(fget=lambda self: self.getEdges())
    #}>b
...
#}>c
    ...
    def purge(self):
        ...
        Purges this graph.
        """
        for i in range(self._numberOfVertices):
            self._vertex[i] = None
        self._numberOfVertices = 0
        self._numberOfEdges = 0
