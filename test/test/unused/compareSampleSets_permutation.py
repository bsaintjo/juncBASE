...
#
        ...
        try:
            if permutation:
                ...
                raw_pval = compareTest(which_test, set1_psis, set2_psis)
        except:
...
#                   continue
            ...
            try:
                if permutation:
                    ...
                    if simple_IR:
                        pval = compareTest(which_test, set1_total_psis,
                                           set2_total_psis)
                    else:
                        left_pval = compareTest(which_test, set1_psis_left,
                                                set2_psis_left)

                        right_pval = compareTest(which_test, set1_psis_right,
                                                 set2_psis_right)
            except:
                print(("Warning: Event not tested: %s" % event))
                continue
